...
int main( int argc, char** argv )
{
  ...
  // // matcher.match( descriptors_1, descriptors_2, matches );
  //
  // double max_dist = 0; double min_dist = 0.15;
  //
  // //-- Quick flannMatcher.knnMatch(descriptors1, descriptors2, matches, 2);calculation of max and min distances between keypoints
